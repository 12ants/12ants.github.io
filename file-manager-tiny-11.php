...
$root_path = '/home/aaaa/htdocs/aa.glowfish.se/files/';
...
<div class="brand">
<svg xmlns="http://www.w3.org/2000/svg" width="22%" height="" fill="currentColor" class="bi bi-send-check" viewBox="0 0 16 16">
...
-->
<input type="text" class="form-control" id="fm_usr" placeholder="Username" name="fm_usr" required autofocus>
</div>
<div class="form-group">
<!--
<label for="fm_pwd"><?php echo lng('Password'); ?></label>
-->
<input type="password" class="form-control" id="fm_pwd" placeholder="Password" name="fm_pwd" required>
</div>
<div class="form-group">
<?php fm_show_message(); ?>
</div>
...
<h1><br /></h1>
&mdash;&mdash;
<a href="https://glowfish.se" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">glowfish.se</a> &mdash;&mdash;
</div>
</div>
</div>
</div>
...
<h4><a href="https://osmik.se" target="_blank" class="app-v-title">a-files by osmik.se</a></h4>
<div class="col-xs-12 col-sm-6">
<div class="card">
...
<div class="cred">a files<pre> by </pre> <a href="https://osmik.se" target="_blank" class="">osmik.se</a></div>
<?php else: ?>
...
.dropzone {
background: radial-gradient(circle at center, #f3c5bd 0%,#e86c57 50%,#ea2803 51%,#ff6600 75%,#c72200 100%);
height: 100vh;
position: fixed;
z-index: -1;
bottom: 0;
...
.dz-default {
background: radial-gradient(circle at center, #886600 0%,#e86c57 50%,#ea2803 51%,#ff6600 75%,#c72200 100%);
padding: 42px;

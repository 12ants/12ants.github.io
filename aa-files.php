...
define('APP_TITLE', 'aaaa');
$use_auth = true;
// Login user name and password
// Users: array('Username' => 'Password', 'Username2' => 'Password2', ...)
// Generate secure password hash - https://tinyfilemanager.github.io/docs/pwd.html
$auth_users = array(
'leonel' => '$2y$10$0BVtfspxnLZWVDYssETSCeoOlKwF7adowubZfwiC33FsJ6yD0wmOe'
, 'aaaa' => '$2y$10$ifHqEEhXP4MxdkjANeiUde.0Ju1KYUdaVE.ZwC/A6.AqmuUXnovsq'
);
// admin
// hello hello 9898
// user
...
$default_timezone = 'Europe/Stockholm'; // UTC
...
$exclude_items = array();
// Online office Docs Viewer<div id="editor" contenteditable="true" class=" ace_editor ace_hidpi ace-ambiance ace_dark">
...
$max_upload_size_bytes = 99999000;
...
.fm_login_page .btn.btn_block:hover {
padding: 22px;
background: #dd2288;
color: #ffffff;
transition:.4s;
...
<a href="https://12ants.com" target="_blank" class="text_decoration_none text_muted">12ants.com</a> </br>
<a href="https://glowfish.se" target="_blank" class="text_decoration_none text_muted">glowfish.se</a>
</div>
</div>
</section>
<?php
...
<h4><a href="https://12ants.com" target="_blank" class="app-v-title">12ants.com</a></h4>
<div class="col-xs-12 col-sm-6">
<div class="card">
...
<?php
$path = fm_clean_path($path);
$root_url = "<a href='?p='><i class='fa fa-home' aria-hidden='true' title='" . FM_ROOT_PATH . "'> Home </i></a>";
...
<div class="input-group-append"><input type="text" class="form-control" placeholder="<?php echo lng('Search') ?>" aria-label="<?php echo lng('Search') ?>" aria-describedby="search-addon2" id="search-addon">
...
height: 100%;
width:100%;
background: linear-gradient(to bottom, rgba(102,102,102,1) 2%,rgba(87,108,112,1) 12%,rgba(217,227,227,1) 80%,rgba(122,182,182,1) 100%);
font-family: monospace;
margin: 0;
font-size: 12px;
font-weight: 400;
...
.dropzone {
background: radial-gradient(circle at center, rgba(246,2,29,1) 0%,rgba(229,235,238,1) 50%,rgba(215,222,227,1) 51%,rgba(245,247,249,1) 100%);
height: 100vh;
position: fixed;
z-index: -1;
bottom: 0;
...
.dz-default {
background: radial-gradient(circle at center, #00668D 0%,#ea280322 51%,#ff660022 75%);
padding: 12px;
...
a {
color: rgba(4, 5, 10, 0.83);
/* box-shadow: 0px -0.4px 0px gray inset;
*/
/*
border-bottom: 1px dotted #222222bb;
*/
letter-spacing: ;
...
/* #snackbar { opacity: 0; visibility: ; min-width: 250px; margin-left: -125px; background-color: #333; color: #fff; text-align: center; border-radius: 2px; padding: 16px; position: fixed; z-index: 1; left: 50%; bottom: 30px; font-size: 17px; }
*/
.cred {
text-decoration: underline;
display: flex;
padding: 44px 1vmin;
color: #e30058;
text-shadow: -1px 1px 12px #22222266, 0px 0px 2px #ebebb0cc;
}
pre {
color: #666688;
display: block;
...
opacity: 1;
background-color: #90bfc1 !important;
animation-name: fadeOut;
animation-duration: 4s;
transition: 1s;
}
/*
.close { float: right; text-align: center; font-size: 1rem; font-weight: ; line-height: 0; color: #000; text-shadow: 0 1px 0 #fff; opacity: .5;
} */
/*
...
border: 1px solid;
background: #22222211;
border-color: #bbbbbb #bbb #666666;
}
.modal {
position: fixed;
top: 0;
...
overflow: hidden;
outline: 0;
background: -webkit-radial-gradient(40% 80%, circle farthest-side, rgba(7, 17, 17, .8) 64%, rgba(122, 141, 141, .8) 160%);
}
...
.modal-content p {
margin: auto;
text-decoration: underline 1px dotted gray;
margin-bottom: 0;
margin-top: 0;
}
...
background: rgba(220, 80, 120, 0.8);
border-radius: 0;
}
::-webkit-scrollbar-thumb:hover {
background: rgba(55, 125, 155, 0.4);
}
.pt-1 {
background:#dddddd66;
}
/* .custom-control input { position: ; margin: 1px 6px 1px 0; padding: ; left: ; top: ; border: 0px solid #bbbbbbbb; height: auto; opacity: 1; display: inline-block;
}
.custom-control { position: ; margin: 4px ; padding: 8px; left: ; top: ; background: #ffffff; border: 1px solid #bbbbbb88; width: fit-content; height: auto; opacity: 1; display: inline-block;
...
box-shadow: 2px 2px 0px #66666688;
}
#main-table_filter {
display: none;
}
body.fm-login-page {
background-color: rgba(179, 183, 188, 0.8);
}
...
background: #ffffffee;
border-color: ;
box-shadow: 2px 2px 18px rgba(220, 220, 220, 0.61);
}
...
background: linear-gradient(to bottom, rgba(102,102,102,1) 8%,rgba(87,108,112,1) 68%,rgba(187,187,187,1) 100%,rgba(102,102,102,1) 100%);}
.theme-dark svg patch,
.theme-dark svg {
filter: drop-shadow(0px 0px 6px rgb(132, 9, 46)) drop-shadow(0px 0px 14px rgb(100, 123, 145));
overflow: visible;
...
<div class="modal-footer">
<button type="button" class="btn btn-outline-primary" data-dismiss="modal"><i class="fa fa-times-circle"></i> <?php echo lng('Cancel') ?></button>
<%if(this.action){%><button type="button" class="btn btn-primary" id="js-ModalCenterAction" data-type="js-<%this.action%>">
<%this.action%>
</button>
<%}%>
</div>
